...
func (s *SchemaApiService) SchemaCreate(ctx context.Context, schemaCreateRequest SchemaCreateRequest) (ImplResponse, error) {
	...
	//TODO: Uncomment the next line to return response Response(200, SchemaCreate200Response{}) or use other options such as http.Ok ...
	//return Response(200, SchemaCreate200Response{}), nil
