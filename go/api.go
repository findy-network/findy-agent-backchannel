...
type IssueCredentialApiServicer interface { 
	...
	IssueCredentialSendRequest(context.Context, UNKNOWN_BASE_TYPE) (ImplResponse, error)
	IssueCredentialStore(context.Context, UNKNOWN_BASE_TYPE) (ImplResponse, error)
}
