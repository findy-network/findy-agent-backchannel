...
func (s *IssueCredentialApiService) IssueCredentialSendOffer(ctx context.Context, uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) (ImplResponse, error) {
...
func (s *IssueCredentialApiService) IssueCredentialSendRequest(ctx context.Context, uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) (ImplResponse, error) {
...
func (s *IssueCredentialApiService) IssueCredentialStore(ctx context.Context, uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) (ImplResponse, error) {
