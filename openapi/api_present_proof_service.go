...
func (s *PresentProofApiService) PresentProofSendRequest(ctx context.Context, presentProofSendRequestRequest PresentProofSendRequestRequest) (ImplResponse, error) {
...
func (s *PresentProofApiService) PresentProofVerifyPresentation(ctx context.Context, presentProofVerifyPresentationRequest PresentProofVerifyPresentationRequest) (ImplResponse, error) {
	...
	//TODO: Uncomment the next line to return response Response(200, PresentProofVerifyPresentation200Response{}) or use other options such as http.Ok ...
	//return Response(200, PresentProofVerifyPresentation200Response{}), nil
